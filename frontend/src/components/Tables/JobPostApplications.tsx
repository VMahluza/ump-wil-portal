...
import { GetApplications, GetJobPost } from "@/lib/data/actions";
...
const JobPostApplicationTable = ({
  jobPostId,
}: JobPostApplicationTableProps) => {
  ...
  return (
    <>
      <div className="flex flex-col gap-4 lg:flex-row">
        ...
        <div className="w-full rounded-[10px] border border-stroke bg-white p-4 shadow-1 dark:border-dark-3 dark:bg-gray-dark dark:shadow-card sm:p-7.5 lg:w-1/4">
          <div className="max-w-full overflow-x-auto p-4">
            {/* Search Box */}
            <JobPostDetails jobPost={jobPost || {}} />
            <JobPostsModalFormUpdate
              jobPost={jobPost || {}}
                    ...
                    >
                      <div className="flex items-center justify-end space-x-3.5">
                        <button
                          ...
                          onClick={() =>
                            router.push(
                              `/jobposts/application/${application.id}`,
                            )
                          }
                        >
                          <svg
